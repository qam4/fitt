...
def build_application(bot_config: TelegramBotConfig) -> Application[Any, Any, Any, Any, Any, Any]:
    ...
    app.add_handler(CommandHandler("eval", _wrap_command(_on_eval)))
...
async def _on_eval(bot: Any, update: IncomingUpdate, services: Services) -> None:
    await handlers.handle_eval_command(bot, update, services)
